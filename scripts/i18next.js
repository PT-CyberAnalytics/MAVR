 ...
 * Original file: /npm/i18next@23.11.5/dist/esm/i18next.js
 *
  ...
  emit(e) {
    ...
    if (this.observers["*"]) {
      Array.from(this.observers["*"].entries()).forEach((t) => {
        let [i, n] = t;
        for (let t = 0; t < n; t++) i.apply(i, [e, ...s]);
      });
    }
  }
}
...
function a(e, t, s) {
  ...
  return n() ? {} : { obj: e, k: i(o[a]) };
}
function l(e, t, s) {
  const { obj: i, k: n } = a(e, t, Object);
  if (void 0 !== i || 1 === t.length) return void (i[n] = s);
  let o = t[t.length - 1],
...
function g(e) {
  return "string" == typeof e ? e.replace(/[&<>"'\/]/g, (e) => c[e]) : e;
}
const d = [" ", ",", "?", "!", ";"],
  f = new (class {
    constructor(e) {
...
function m(e, t) {
  ...
  for (let e = 0; e < i.length; ) {
    ...
    for (let r = e; r < i.length; ++r)
      if ((r !== e && (o += s), (o += i[r]), (t = n[o]), void 0 !== t)) {
        if (
...
class v extends i {
  ...
  getResource(e, t, s) {
    ...
    return (
      ...
      a || !o || "string" != typeof s
        ? a
        : m(this.data && this.data[e] && this.data[e][t], s, n)
    );
  }
  addResource(e, t, s, i) {
    let n =
...
var b = {
  ...
  handle(e, t, s, i, n) {
    return (
      e.forEach((e) => {
        this.processors[e] && (t = this.processors[e].process(t, s, i, n));
      }),
      t
    );
  },
...
class S extends i {
  ...
  extractFromKey(e, t) {
    ...
    const o = s && e.indexOf(s) > -1,
      r = !(
        ...
        (function (e, t, s) {
          ((t = t || ""), (s = s || ""));
          const i = d.filter((e) => t.indexOf(e) < 0 && s.indexOf(e) < 0);
    ...
    if (
      ...
      if (!t.returnObjects && !this.options.returnObjects) {
        ...
        const e = this.options.returnedObjectHandler
          ? this.options.returnedObjectHandler(c, p, { ...t, ns: r })
          : `key '${o} (${this.language})' returned an object instead of string.`;
        return i
          ? ((h.res = e), (h.usedParams = this.getUsedParamsDetails(t)), h)
          : e;
      }
      if (n) {
        ...
        for (const e in p)
          if (Object.prototype.hasOwnProperty.call(p, e)) {
            const o = `${i}${n}${e}`;
            ((s[e] = this.translate(o, { ...t, joinArrays: !1, ns: r })),
              s[e] === o && (s[e] = p[e]));
          }
        p = s;
      }
    } else if (m && "string" == typeof f && Array.isArray(p))
      ((p = p.join(f)), p && (p = this.extendTranslation(p, e, t, s)));
    else {
      let i = !1,
        r = !1;
      ...
      if (r || i || v) {
        if (
          (this.logger.log(v ? "updateKey" : "missingKey", l, a, o, v ? m : p),
          n)
        ) {
        ...
        const i = (e, s, i) => {
          ...
          (this.options.missingKeyHandler
            ? this.options.missingKeyHandler(e, a, s, n, v, t)
            : this.backendConnector &&
              this.backendConnector.saveMissing &&
              this.backendConnector.saveMissing(e, a, s, n, v, t),
            this.emit("missingKey", e, a, s, p));
        };
          ...
          (this.options.saveMissingPlurals && u
            ? e.forEach((e) => {
                ...
                (f &&
                  ...
                  s.forEach((s) => {
                    i([e], o + s, t[`defaultValue${s}`] || m);
                  }));
              })
            : i(e, o, m));
      }
      ((p = this.extendTranslation(p, e, t, h, s)),
        r &&
          p === o &&
  ...
  extendTranslation(e, t, s, i, n) {
    ...
    if (this.i18nFormat && this.i18nFormat.parse)
      ...
      if (
        ...
        (e = this.interpolator.interpolate(e, l, s.lng || this.language, s)),
        r)
      ) {
        const t = e.match(this.interpolator.nestingRegexp);
  ...
  resolve(e) {
    ...
    return (
          ...
          this.isValidLookup(t) ||
            ...
            g.forEach((s) => {
              ...
              if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                this.i18nFormat.addLookupKeys(o, l, s, e, r);
              else {
                let e;
                h && (e = this.pluralResolver.getSuffix(s, r.count, r));
                ...
                if (
                  ...
                  (o.push(s),
                    h &&
                      ...
                      r.ordinal &&
                        0 === e.indexOf(i) &&
                        o.push(s + e.replace(i, this.options.pluralSeparator)),
                      p && o.push(s + t)));
                }
              }
              let a;
      ...
      { res: t, usedKey: s, exactUsedKey: i, usedLng: n, usedNS: o }
    );
  }
  isValidLookup(e) {
    return !(
...
class O {
  ...
  getScriptPartFromCode(e) {
    if (!(e = y(e)) || e.indexOf("-") < 0) return null;
    const t = e.split("-");
    return 2 === t.length
      ? null
      : (t.pop(),
  ...
  toResolveHierarchy(e, t) {
    ...
    return (
      ...
      s.forEach((e) => {
        i.indexOf(e) < 0 && n(this.formatLanguageCode(e));
      }),
      i
    );
  }
...
class C {
    ...
    ((this.languageUtils = e),
      ...
      (this.rules = (function () {
        ...
        return (
          L.forEach((t) => {
            t.lngs.forEach((s) => {
              e[s] = { numbers: t.nr, plurals: w[t.fc] };
            });
          }),
          e
        );
  ...
  getRule(e) {
    ...
    if (this.shouldUseIntlApi())
      try {
        return new Intl.PluralRules(y("dev" === e ? "en" : e), {
...
function P(e, t, s) {
  let i = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : ".",
    ...
    o = (function (e, t, s) {
      const i = u(e, s);
      return void 0 !== i ? i : u(t, s);
    })(e, t, s);
  return (
    !o &&
      n &&
      "string" == typeof s &&
      ((o = m(e, s, i)), void 0 === o && (o = m(t, s, i))),
    o
  );
}
class j {
    ...
    const h = (e) => {
      if (e.indexOf(this.formatSeparator) < 0) {
        ...
        return this.alwaysFormat
          ? this.format(n, void 0, s, { ...i, ...t, interpolationkey: e })
          : n;
      }
      ...
      return this.format(
        P(t, l, o, this.options.keySeparator, this.options.ignoreJSONStructure),
        r,
        s,
        ...
        for (a = 0; (n = t.regex.exec(e)); ) {
          ...
          if (((r = h(s)), void 0 === r))
            if ("function" == typeof p) {
              const t = p(e, n, i);
              r = "string" == typeof t ? t : "";
            } else if (i && Object.prototype.hasOwnProperty.call(i, s)) r = "";
            else {
              if (c) {
                r = n[0];
                continue;
    ...
    for (; (s = this.nestingRegexp.exec(e)); ) {
      ...
      ("string" != typeof i && (i = o(i)),
        ...
        u &&
          (i = l.reduce(
            (e, t) =>
              this.format(e, t, r.lng, { ...r, interpolationkey: s[1].trim() }),
            i.trim(),
          )),
        (e = e.replace(s[0], i)),
...
class I {
  ...
  format(e, t, s) {
    ...
    return t.split(this.formatSeparator).reduce((e, t) => {
      const { formatName: n, formatOptions: o } = (function (e) {
        ...
        if (e.indexOf("(") > -1) {
          ...
          "currency" === t && n.indexOf(":") < 0
            ? s.currency || (s.currency = n.trim())
            : "relativetime" === t && n.indexOf(":") < 0
...
class F extends i {
  constructor(e, t, i) {
    ...
    (super(),
      ...
      (this.state = {}),
      (this.queue = []),
      this.backend && this.backend.init && this.backend.init(i, n.backend, n));
  }
  queueLoad(e, t, s, i) {
    const n = {},
      o = {},
  ...
  read(e, t, s) {
    ...
    const r = (r, a) => {
        ...
        r && a && i < this.maxRetries
          ? setTimeout(() => {
              this.read.call(this, e, t, s, i + 1, 2 * n, o);
            }, n)
          : o(r, a);
      },
  ...
  loadOne(e) {
    ...
    this.read(i, n, "read", void 0, void 0, (s, o) => {
      (s &&
        ...
        !s &&
          o &&
          this.logger.log(`${t}loaded namespace ${n} for language ${i}`, o),
        this.loaded(e, s, o));
    });
  }
    ...
    if (
      ...
      if (this.backend && this.backend.create) {
        ...
        if (l.length < 6)
          try {
            let n;
            ((n = 5 === l.length ? l(e, t, s, i, a) : l(e, t, s, i)),
...
class U extends i {
  ...
  init() {
    ...
    if (
      ((this.options = { ...o, ...this.options, ...V(t) }),
      "v1" !== this.options.compatibilityAPI &&
        (this.options.interpolation = {
          ...o.interpolation,
          ...this.options.interpolation,
  ...
  getFixedT(e, t, s) {
    ...
    const n = function (e, t) {
      ...
      if ("object" != typeof t) {
        for (
          ...
          a[l - 2] = arguments[l];
        o = i.options.overloadTranslationOptionHandler([e, t].concat(a));
      } else o = { ...t };
      ((o.lng = o.lng || n.lng),
    ...
    return (
      "string" == typeof e ? (n.lng = e) : (n.lngs = e),
      (n.ns = t),
      (n.keyPrefix = s),
      n
    );
  ...
  dir(e) {
    if (
      ...
      return "rtl";
    const t = (this.services && this.services.languageUtils) || new O(A());
    return [
      "ar",
      "shu",
      "sqr",
...
T.createInstance = U.createInstance;
const K = T.createInstance,
  M = T.dir,
  z = T.init,
  H = T.loadResources,
  J = T.reloadResources,
  ...
  W = T.t,
  Y = T.exists,
  Q = T.setDefaultNamespace,
  G = T.hasLoadedNamespace,
  X = T.loadNamespaces,
  Z = T.loadLanguages;
export {
  q as changeLanguage,
  ...
  Y as exists,
  _ as getFixedT,
  G as hasLoadedNamespace,
  z as init,
  Z as loadLanguages,
  X as loadNamespaces,
  H as loadResources,
  J as reloadResources,
  Q as setDefaultNamespace,
  W as t,
  B as use,
};
